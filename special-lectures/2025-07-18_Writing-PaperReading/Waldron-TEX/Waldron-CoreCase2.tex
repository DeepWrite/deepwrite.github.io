...
Source: The Yale Law Journal , Apr., 2006, Vol. 115, No.~6 (Apr., 2006),
pp.~1346-1406\\
...
몇 가지 가정을 제시할 것이다. 이 에세이의 논증은 무조건적인 것이 아니라,
...
VII부에서는 핵심 논변(core argument)이 의존하는 가정들에서 벗어나야 할
...
것은 사법심사에 대한 결론 중심(bottom-line mentality) 사고방식의
일종이다.\footnote{정치철학에서의 `결과지상주의(bottom-line
...
society)라고 가정한다. 이 사회는 현대 서구 세계의 대부분과 마찬가지로,
...
가정한다.\footnote{때때로 선출 제도(elective institutions)는 자기 개혁이
...
정당성(legitimacy)에 대해 스스로 의식하고 있다고 가정한다. 이는 그들이
...
이데올로기(official ideology)의 일부라고 가정한다.
...
관심을 갖고 있다는 것이었다. 네 번째 가정은, 의견불일치(disagreement)가
...
강조하고 싶은 것은, 그것이 이 논문에서 전제한 세 번째 가정(third
assumption)과 양립하지 않는다는 점이다. 따라서 우리는 권리(rights)에
...
설정한 세 번째, 네 번째 가정이 충족된 사회에서 기대할 수 있는 모습이다.
